...
const HeroSection = () => {
  return (
    <div 
      className="bg-[#1167B1] text-white relative overflow-hidden h-[635px]"
      style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="z-10">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-tight mb-4">
              Know The Root Cause Of<br />
              Your Baldness
            </h1>
            
            <p className="text-sm md:text-base mb-6">
              Restore your hair with advanced treatments at our leading<br />
              clinic, offering expert care for natural, lasting results.
            </p>
            
            <div className="flex flex-col gap-4 mb-6 font-roboto">
              <button className="w-[289px] h-11.5 bg-[#231F20] text-white py-2 px-6 rounded  font-medium">
                BOOK YOUR APPOINTMENT
              </button>
              <div className="w-[289px] text-white font-semibold text-lg">
          ...
          <div className="relative md:flex justify-end">
            <img 
              src="/image.png" 
              alt="Female Doctor" 
              className="max-w-full md:max-w-[90%] relative z-10 h-[589px]"
            />
            
            {/* Stats Badges */}
            <div 
              className="absolute bg-white text-black rounded-[76.98px] flex flex-col items-center justify-center z-20 w-43.5 h-16 py-1 shadow-[0px_5.83px_11.66px_0px_#0000001A]"
              style={{
                gap: '12.22px',
                top: '120px',
                left: '20.24px',
            ...
            <div 
              className="absolute z-20 flex flex-col items-center justify-center rounded-[52.8px] text-white w-43.5 h-13.5 py-1"
              style={{
            ...
            <div 
              className="absolute z-20 flex flex-col items-center justify-center rounded-[52.8px] text-white"
              style={{
                width: '174.95px',
                height: '59.67px',
                top: '330px',
            ...
            >
              ...
              <svg width="38" height="38" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_2299_14804)">
            ...
            <div 
              className="absolute bg-white text-black rounded-[76.98px] flex flex-col items-center justify-center z-20 w-43.5 h-14.5 py-1.5"
              style={{
